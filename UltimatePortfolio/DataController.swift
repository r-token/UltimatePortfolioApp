...
class DataController: ObservableObject {
    ...
    private func delete(_ fetchRequest: NSFetchRequest<NSFetchRequestResult>) {
        ...
        // then merge all the changes from the result back into our live view context
    ...
    /// Runs a fetch request with various predicates that filter the user's issued based on
